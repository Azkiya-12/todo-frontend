...
export const metadata = {
    ...
    description: 'Modul Praktik Mahasiswa: fetch API, Layer Services, Types, Lib, dan Next.js Router Handler',
};

export default async function ApiTodosPage() {
    let initialTasks: Awaited<ReturnType<typeof getTasks>>['tasks'] = [];
    try {
        // Memanggil data awal di server Component memlalui bisiness logic helper
